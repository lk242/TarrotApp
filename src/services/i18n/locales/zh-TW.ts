const zhTW = {
  ...
  billing: {
    ...
    packages: {
      starter: { name: '入門補充包', description: '約 20 次提問，適合偶爾使用。' },
      standard: { name: '標準靈感包', description: '約 44 次提問，單次成本更低。' },
      deep: { name: '深度探索包', description: '約 87 次提問，適合大量追問。' },
    },
    subscriptions: {
      monthly_light: { name: '月光方案', description: '每月約 30 次提問，輕鬆維持占卜習慣。' },
      monthly_plus: { name: '星辰方案', description: '每月約 64 次提問，最受歡迎的超值選擇。' },
      monthly_pro: { name: '神諭方案', description: '每月約 127 次提問，深度探索不設限。' },
    },
  },
