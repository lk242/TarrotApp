...
const major = (
  ...
  arcana: 'major',
  number,
  imageUrl: `/cards/major-${String(number).padStart(2, '0')}.jpg`,
  keywords,
  reversedKeywords,
});
...
const minor = (
  ...
  suit: suit!,
  number,
  imageUrl: `/cards/${suit}-${String(number).padStart(2, '0')}.jpg`,
  keywords,
  reversedKeywords,
});

export const MAJOR_ARCANA: TarotCard[] = [
  major(0, '愚者', 'The Fool', ['新開始', '冒險', '天真'], ['魯莽', '猶豫', '冒失']),
  major(1, '魔術師', 'The Magician', ['創造力', '意志力', '技能'], ['欺騙', '操控', '才能浪費']),
  major(2, '女祭司', 'The High Priestess', ['直覺', '潛意識', '神秘'], ['封閉', '壓抑直覺', '表面化']),
  major(3, '皇后', 'The Empress', ['豐饒', '母性', '自然'], ['依賴', '空虛', '創造力匱乏']),
  major(4, '皇帝', 'The Emperor', ['權威', '穩定', '領導'], ['專制', '僵化', '控制慾']),
  major(5, '教皇', 'The Hierophant', ['傳統', '指導', '信仰'], ['教條', '叛逆', '非傳統']),
  major(6, '戀人', 'The Lovers', ['愛情', '選擇', '和諧'], ['失衡', '價值觀衝突', '猶豫不決']),
  major(7, '戰車', 'The Chariot', ['決心', '勝利', '前進'], ['失控', '挫敗', '方向迷失']),
  major(8, '力量', 'Strength', ['勇氣', '耐心', '內在力量'], ['軟弱', '自我懷疑', '缺乏自信']),
  major(9, '隱者', 'The Hermit', ['內省', '智慧', '獨處'], ['孤立', '退縮', '過度封閉']),
  major(10, '命運之輪', 'Wheel of Fortune', ['轉變', '機遇', '命運'], ['逆境', '抗拒改變', '厄運']),
  major(11, '正義', 'Justice', ['公正', '真相', '因果'], ['不公', '逃避責任', '偏見']),
  major(12, '倒吊人', 'The Hanged Man', ['放下', '新視角', '等待'], ['拖延', '無謂犧牲', '固執']),
  major(13, '死神', 'Death', ['結束', '轉化', '重生'], ['抗拒改變', '停滯', '恐懼']),
  major(14, '節制', 'Temperance', ['平衡', '調和', '耐心'], ['過度', '失衡', '缺乏遠見']),
  major(15, '惡魔', 'The Devil', ['束縛', '慾望', '物質'], ['解放', '打破枷鎖', '覺醒']),
  major(16, '高塔', 'The Tower', ['劇變', '破壞', '啟示'], ['恐懼改變', '苟延殘喘', '逃避']),
  major(17, '星星', 'The Star', ['希望', '靈感', '平靜'], ['失望', '缺乏信心', '斷開連結']),
  major(18, '月亮', 'The Moon', ['幻象', '潛意識', '不安'], ['釋放恐懼', '真相大白', '克服困惑']),
  major(19, '太陽', 'The Sun', ['喜悅', '成功', '活力'], ['暫時挫折', '過度樂觀', '延遲']),
  major(20, '審判', 'Judgement', ['覺醒', '重生', '召喚'], ['自我懷疑', '逃避審視', '拒絕成長']),
  major(21, '世界', 'The World', ['完成', '成就', '圓滿'], ['未竟之業', '停滯', '缺乏結束']),
];
