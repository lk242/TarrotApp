...
export const CREDIT_PACKAGES: CreditPackage[] = [
  {
    ...
    bonusCredits: 0,
    priceTwd: 129,
    description: 'AI 塔羅解讀服務額度，約 20 次全新占卜，或 80 次追問。',
  },
  {
    id: 'standard',
    name: '標準解讀方案',
    ...
    bonusCredits: 80,
    priceTwd: 269,
    description: 'AI 塔羅解讀服務額度，約 44 次全新占卜，或 176 次追問。',
    featured: true,
  },
  {
    id: 'deep',
    ...
    bonusCredits: 150,
    priceTwd: 529,
    description: 'AI 塔羅解讀服務額度，約 87 次全新占卜，或 350 次追問。',
  },
];
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    bonusCredits: 0,
    priceTwd: 199,
    description: 'AI 塔羅解讀月方案，每月約 30 次全新占卜，或 120 次追問。',
  },
  {
    id: 'monthly_plus',
    name: '星辰解讀月方案',
    ...
    bonusCredits: 80,
    priceTwd: 399,
    description: 'AI 塔羅解讀月方案，每月約 64 次全新占卜，或 256 次追問。',
    featured: true,
  },
  {
    id: 'monthly_pro',
    ...
    bonusCredits: 150,
    priceTwd: 749,
    description: 'AI 塔羅解讀月方案，每月約 127 次全新占卜，或 510 次追問。',
  },
];
