const zhTW = {
  ...
  reading: {
    ...
    freeTrialButton: '免費體驗抽牌',
    trialTitle: '你的牌已翻開',
    trialDesc: '登入或註冊即可獲得免費解讀次數，解鎖完整的塔羅指引',
    trialCTA: '免費註冊，解鎖解讀',
    trialHint: '新會員自動獲得體驗解讀次數',
    capturing: '截圖中...',
    viewHistory: '查看占卜紀錄 →',
    yourQuestion: '你的問題',
    upright: '正位',
  ...
  footer: {
    tagline: '以古老智慧照亮前方道路',
    contact: '客服聯絡：lukewolf899@gmail.com',
  },

  // 服務說明（首頁 + 購買頁共用）
  serviceInfo: {
    homeTitle: '塔羅牌線上解讀服務',
    homeDesc: '神秘塔羅提供線上塔羅牌文字解讀服務。使用者可選擇牌陣、輸入問題、抽取塔羅牌，並取得依照牌義、牌位與問題脈絡生成的個人化解讀內容。',
    homeCreditsNote: '付款方案購買的是本站塔羅解讀服務次數，可用於全新占卜與同一輪占卜後的延伸追問；服務次數僅限本站帳戶本人於本站使用，不具貨幣價值，不得轉讓、兌換現金或作為其他商品交易使用。',
    billingTitle: '塔羅解讀服務說明',
    billingDesc: '本頁銷售內容為「神秘塔羅」線上塔羅牌解讀服務，包含全新牌陣解讀與同一輪解讀後的延伸追問服務。服務次數僅限本站帳戶本人於本站使用，不具貨幣價值，不得轉讓、兌換現金或用於其他平台商品交易。',
    billingHow: '服務提供方式：付款完成後，系統會自動將可使用的解讀服務次數加入會員帳戶，使用者可在本站輸入問題、抽牌並取得個人化塔羅文字解讀。',
    contactEmail: '客服聯絡 Email：lukewolf899@gmail.com',
  },
  ...
  history: {
    ...
    followUpButton: '追問',
    deleteRecord: '刪除紀錄',
    showAllLangs: '顯示所有語系紀錄',
    showCurrentLang: '僅顯示當前語系',
  ...
  billing: {
    title: '塔羅占卜解讀服務方案',
    subtitle: '註冊或 Google 登入會自動贈送體驗次數；全新占卜 {readingCost} 次，追問 {followUpCost} 次。',
    welcome: '{name}，歡迎回來',
    welcomeHint: '願星辰指引你的每一次占卜',
    availablePoints: '目前可用解讀次數',
    canAsk: '約可再占卜 {readingCount} 次，或追問 {followUpCount} 次',
    loginPrompt: '請先登入，系統會建立你的服務帳戶並發放新會員體驗次數。',
    goLogin: '前往占卜頁登入',
    buyCredits: '選擇解讀服務方案',
    subscribe: '訂閱方案',
    buy: '購買',
    ...
    creating: '建立中...',
    perMonth: '/ 月',
    pointsCount: '可解讀約 {readingCount} 次占卜 / {followUpCount} 次追問',
    bonusTag: '加贈 {bonus} 次解讀服務',
    monthlyCount: '每月可解讀約 {readingCount} 次占卜 / {followUpCount} 次追問',
    packages: {
      starter: { name: '入門解讀方案', description: '塔羅解讀服務，約 20 次全新占卜，或 80 次追問。' },
      standard: { name: '標準解讀方案', description: '塔羅解讀服務，約 44 次全新占卜，或 176 次追問。' },
      deep: { name: '深度解讀方案', description: '塔羅解讀服務，約 87 次全新占卜，或 350 次追問。' },
    },
    subscriptions: {
      monthly_light: { name: '月光解讀月方案', description: '塔羅解讀月訂閱，每月約 30 次全新占卜，或 120 次追問。' },
      monthly_plus: { name: '星辰解讀月方案', description: '塔羅解讀月訂閱，每月約 64 次全新占卜，或 256 次追問。' },
      monthly_pro: { name: '神諭解讀月方案', description: '塔羅解讀月訂閱，每月約 127 次全新占卜，或 510 次追問。' },
    },
  ...
  about: {
    title: '關於神秘塔羅',
    intro: '神秘塔羅融合了流傳數百年的塔羅牌智慧與現代科技，為每一位探索者打造專屬的占卜體驗。無論你是塔羅新手還是資深愛好者，都能在這裡找到啟發與方向。',
    coreFeatures: '核心特色',
    spreadIntro: '牌陣介紹',
    tips: '占卜小提示',
    historyTitle: '韋特塔羅的歷史',
    disclaimer: '⚠ 免責聲明：塔羅牌是一種自我探索與反思的工具，並非科學預測方法。本站提供的解讀內容僅供參考，不應作為醫療、法律、財務等專業決策的依據。面對重要人生決定，請諮詢相關專業人士。',
    historyContent: [
    ...
    features: [
      ...
      { sigil: '⊛', title: '深度個人化解讀', desc: '根據你的問題、牌陣位置和正逆位，結合塔羅牌義與心理學框架，提供深度個人化的解讀分析。' },
      { sigil: '✧', title: '沉浸式互動體驗', desc: '精心設計的洗牌、切牌、扇形攤牌動畫，配合金色粒子特效，打造如臨現場的占卜儀式感。' },
      { sigil: '◈', title: '追問對話系統', desc: '占卜結果不再是一次性的。透過引導式追問，深入探索每個面向，獲得更完整的指引。' },
